...
// that errorHandling/policies.js suppresses, the raw body has no "result" at all — return
// an empty array so this page contributes zero rows and paging's rowCountIn sees 0, which
// is what stops pagination cleanly (see errorHandling/policies.js for why that's needed).
